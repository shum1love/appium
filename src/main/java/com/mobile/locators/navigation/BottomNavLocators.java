...
public final class BottomNavLocators {
    ...
    public static final By TAB_SEARCH_BY_ID = AppiumBy.id("org.wikipedia:id/nav_tab_search");
    public static final By TAB_SEARCH_BY_TEXT = AppiumBy.xpath("//*[@text='Search' or @content-desc='Search']");
}
